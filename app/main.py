...
from .routers.school_authority_management.grades import router as grades_router
from .routers.quiz import router as quiz_router
from .routers.cbse_simple import router as cbse_router
from .routers.cbse_pdf import router as cbse_pdf_router
from .routers.assignment_submissions import router as assignments_router
from .routers.grading import router as grading_router
from .routers.cbse_quiz import router as cbse_quiz_router
from .routers.ai_quiz import router as ai_quiz_router
...
app.include_router(cbse_router)
app.include_router(cbse_pdf_router)
app.include_router(assignments_router)
app.include_router(grading_router)
app.include_router(cbse_quiz_router)
