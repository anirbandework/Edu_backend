...
async def submit_quiz_answer(
    ...
    print(f"DEBUG: Student Answer: '{student_answer}' -> '{student_answer_clean}'")
    print(f"DEBUG: Correct Answer: '{question_data[0]}' -> '{correct_answer}'")
...
async def complete_quiz_attempt(
    ...
    # Debug logging
    print(f"DEBUG COMPLETE: Attempt ID: {attempt_id}")
    print(f"DEBUG COMPLETE: Total Score: {total_score}")
    print(f"DEBUG COMPLETE: Max Score: {max_score}")
    print(f"DEBUG COMPLETE: Answer Count: {answer_count}")
