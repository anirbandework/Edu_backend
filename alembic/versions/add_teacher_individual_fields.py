"""Add individual fields to teachers table

Revision ID: add_teacher_individual_fields
Revises: add_gender_teacher_student
Create Date: 2025-11-03 21:20:00.000000
...
revision: str = 'add_teacher_individual_fields'
...
def upgrade() -> None:
    # Add individual fields to teachers table
    op.add_column('teachers', sa.Column('first_name', sa.String(length=50), nullable=False, server_default=''))
    op.add_column('teachers', sa.Column('last_name', sa.String(length=50), nullable=False, server_default=''))
    op.add_column('teachers', sa.Column('email', sa.String(length=100), nullable=False, server_default=''))
    op.add_column('teachers', sa.Column('phone', sa.String(length=20), nullable=False, server_default=''))
    ...
    op.add_column('teachers', sa.Column('position', sa.String(length=100), nullable=False, server_default=''))
